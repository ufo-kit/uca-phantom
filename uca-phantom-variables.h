...
Unit variables[] = {
    ...
    {"meta.comment", G_TYPE_STRING,     G_PARAM_READWRITE,  PROP_META_COMMENT,  TRUE},  // note: these are 4096chars long !
    {"meta.xset",    G_TYPE_STRING,     G_PARAM_READWRITE,  PROP_META_XSET, TRUE}, // note: these are 4096chars long !
    // cam
